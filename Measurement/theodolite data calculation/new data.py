...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 10 03:06:25 2022
...
T, A, E = np.loadtxt('new data.txt',usecols=(1,2,3),unpack=True)
...
plt.savefig('uvwind2.png',dpi=300)
plt.show()
plt.close()
...
plt.savefig('uvwswd2.png',dpi=300)
plt.show()
plt.close()
